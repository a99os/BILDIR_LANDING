export default {
  ...
  benfitsTitle: "Bizning platformamizning afzalliklari",
  benfitsItem1: "Bir daqiqada ro'yxatdan o'ting",
  benfitsItem2: "Hisobotlarni qabul qilish",
  benfitsItem3: "Xodimni kuzatib boring",
