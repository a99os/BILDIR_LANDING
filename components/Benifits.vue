<template>
  <div class="py-6">
    <div class="container">
      ...
      <ul class="grid lg:grid-cols-3 gap-10 lg:gap-0 justify between mt-10">
        <li class="flex flex-col-reverse lg:flex-col gap-9">
          <img src="~/assets/images/Benifits1.svg" class="mx-auto" />
          <p class="text-[16px] lg:text-[20px] font-semibold text-center mt-9">
            {{ $t("benifitsItem1") }}
          </p>
        </li>
        <li class="flex flex-col-reverse lg:flex-col gap-9">
