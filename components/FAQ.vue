    ...
    <div class="container">
      ...
      >
        <div class="bg-white acc mx-auto w-full">
          <h2 id="accordion-collapse-heading-10 w-full">
            <button
              type="button"
            ...
            >
              <span class="text-start piramid">Lorem Imsum dolor sit?</span>
              <svg
                data-accordion-icon
          ...
          >
            ...
            >
              <p class="mb-2 text-gray-500 dark:text-gray-400">
                ...
                posuere vel venenatis eu sit massa volutpat. Lorem ipsum dolor
                sit amet consectetur adipiscing elit dolor posuere vel venenatis
                eu sit massa volutpat.
              </p>
            </div>
          </div>
        </div>
        <div class="bg-white acc mx-auto mt-6">
          <h2 class="" id="accordion-collapse-heading-11">
            <button
              type="button"
              class="flex items-center justify-between w-full p-5 font-medium"
        ...
        <div class="bg-white acc mx-auto mt-6">
          <h2 class="" id="accordion-collapse-heading-12">
            <button
              type="button"
              class="flex items-center justify-between w-full p-5 font-medium"
        ...
        <div class="bg-white acc mx-auto mt-6">
          <h2 class="" id="accordion-collapse-heading-13">
            <button
              type="button"
              class="flex items-center justify-between w-full p-5 font-medium"
        ...
        <div class="bg-white acc mx-auto mt-6">
          <h2 class="" id="accordion-collapse-heading-15">
            <button
              type="button"
              class="flex items-center justify-between w-full p-5 font-medium"
